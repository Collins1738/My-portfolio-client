...
export default function Usability() {
	...
	return (
		<Box
			...
			borderRadius="5px"
		>
			<Box m="auto" w="100%" overflow="hidden" p="40px">
				<Heading {...headerStyles}>
					This site did not always look like this...
				</Heading>
				<Text {...textStyles}>
					When I first created this site, I did without much design
					thought. As I grew as a software engineer, I realized the
					site needed a major revamp. So, I conducted usability tests
					and using the results, I was able to transform the site
					from:
				</Text>
				<Flex
				...
				<Text {...textStyles}>
					Here is the full usability report where I discuss my reasons
					and thought process behind the new design!
				</Text>
				<Box my="20px" />
